...
public sealed class EntryDocumentTemplateService : IEntryDocumentTemplateService
{
    ...
    private static void BuildEntriesSheet(ExcelWorksheet ws)
    {
        ...
        ws.Column(1).Width = 29.7265625;
        ws.Column(2).Width = 27.7265625;
        ws.Column(3).Width = 13.90625;
        ws.Column(4).Width = 17.6328125;
        ws.Column(5).Width = 13.90625;
        ws.Column(6).Width = 13.90625;
        ws.Column(8).Width = 8.90625;
