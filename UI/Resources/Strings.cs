...
public static class Strings
{
    ...
    public static string Settings_Scoring_Title => Get(nameof(Settings_Scoring_Title));
    public static string Settings_Scoring_Description => Get(nameof(Settings_Scoring_Description));
    public static string Settings_Scoring_Recalculating => Get(nameof(Settings_Scoring_Recalculating));
    public static string Settings_Scoring_Mode => Get(nameof(Settings_Scoring_Mode));
    public static string Settings_Scoring_Mode_Description => Get(nameof(Settings_Scoring_Mode_Description));
    public static string Settings_Scoring_PlaceTable => Get(nameof(Settings_Scoring_PlaceTable));
    public static string Settings_Scoring_PlaceTable_Description => Get(nameof(Settings_Scoring_PlaceTable_Description));
    public static string Settings_Scoring_PlaceColumn => Get(nameof(Settings_Scoring_PlaceColumn));
    public static string Settings_Scoring_PlaceRow => Get(nameof(Settings_Scoring_PlaceRow));
    public static string Settings_Scoring_PointsColumn => Get(nameof(Settings_Scoring_PointsColumn));
    public static string Settings_Scoring_RemoveLastPlace => Get(nameof(Settings_Scoring_RemoveLastPlace));
    public static string Settings_Scoring_ResetDefaults => Get(nameof(Settings_Scoring_ResetDefaults));
    public static string Settings_Scoring_Apply => Get(nameof(Settings_Scoring_Apply));
    public static string Settings_Scoring_RecalcError_Title => Get(nameof(Settings_Scoring_RecalcError_Title));
    public static string Settings_Scoring_RecalcError_Message => Get(nameof(Settings_Scoring_RecalcError_Message));
